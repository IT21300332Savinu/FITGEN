...
class MeetupReserveRecord extends FirestoreRecord {
  ...
  // "mr_equipment" field.
  String? _mrEquipment;
  String get mrEquipment => _mrEquipment ?? '';
  bool hasMrEquipment() => _mrEquipment != null;

  // "mr_comments" field.
  DocumentReference? _mrComments;
  DocumentReference? get mrComments => _mrComments;
  bool hasMrComments() => _mrComments != null;

  // "mr_hostnum" field.
  String? _mrHostnum;
  String get mrHostnum => _mrHostnum ?? '';
  bool hasMrHostnum() => _mrHostnum != null;
  ...
  void _initializeFields() {
    ...
    _mrEquipment = snapshotData['mr_equipment'] as String?;
    _mrComments = snapshotData['mr_comments'] as DocumentReference?;
    _mrHostnum = snapshotData['mr_hostnum'] as String?;
  }
...
Map<String, dynamic> createMeetupReserveRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'mr_sport': mrSport,
      'mr_host': mrHost,
      'mr_equipment': mrEquipment,
      'mr_comments': mrComments,
      'mr_hostnum': mrHostnum,
    }.withoutNulls,
  );
...
class MeetupReserveRecordDocumentEquality
  ...
  bool equals(MeetupReserveRecord? e1, MeetupReserveRecord? e2) {
    return e1?.mrMeetup == e2?.mrMeetup &&
        ...
        e1?.mrHost == e2?.mrHost &&
        e1?.mrEquipment == e2?.mrEquipment &&
        e1?.mrComments == e2?.mrComments &&
        e1?.mrHostnum == e2?.mrHostnum;
  }
