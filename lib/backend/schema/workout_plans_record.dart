...
class WorkoutPlansRecord extends FirestoreRecord {
  ...
  // "workout_person" field.
  String? _workoutPerson;
  String get workoutPerson => _workoutPerson ?? '';
  bool hasWorkoutPerson() => _workoutPerson != null;
  ...
  void _initializeFields() {
    ...
    _workoutPerson = snapshotData['workout_person'] as String?;
  }
...
class WorkoutPlansRecordDocumentEquality
  ...
  bool equals(WorkoutPlansRecord? e1, WorkoutPlansRecord? e2) {
    ...
    return e1?.spuserRef == e2?.spuserRef &&
        ...
        e1?.status == e2?.status &&
        e1?.workoutPerson == e2?.workoutPerson;
  }
