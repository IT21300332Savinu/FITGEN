...
class MeetupRecord extends FirestoreRecord {
  ...
  // "meetup_equipment" field.
  String? _meetupEquipment;
  String get meetupEquipment => _meetupEquipment ?? '';
  bool hasMeetupEquipment() => _meetupEquipment != null;

  // "meetup_comments" field.
  DocumentReference? _meetupComments;
  DocumentReference? get meetupComments => _meetupComments;
  bool hasMeetupComments() => _meetupComments != null;

  // "meetup_hostnum" field.
  String? _meetupHostnum;
  String get meetupHostnum => _meetupHostnum ?? '';
  bool hasMeetupHostnum() => _meetupHostnum != null;
  ...
  void _initializeFields() {
    ...
    _meetupEquipment = snapshotData['meetup_equipment'] as String?;
    _meetupComments = snapshotData['meetup_comments'] as DocumentReference?;
    _meetupHostnum = snapshotData['meetup_hostnum'] as String?;
  }
...
Map<String, dynamic> createMeetupRecordData({
  ...
  String? meetupEquipment,
  DocumentReference? meetupComments,
  String? meetupHostnum,
}) {
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'meetup_equipment': meetupEquipment,
      'meetup_comments': meetupComments,
      'meetup_hostnum': meetupHostnum,
    }.withoutNulls,
  );
...
class MeetupRecordDocumentEquality implements Equality<MeetupRecord> {
  ...
  bool equals(MeetupRecord? e1, MeetupRecord? e2) {
    return e1?.meetupSport == e2?.meetupSport &&
        ...
        e1?.meetupEquipment == e2?.meetupEquipment &&
        e1?.meetupComments == e2?.meetupComments &&
        e1?.meetupHostnum == e2?.meetupHostnum;
  }
