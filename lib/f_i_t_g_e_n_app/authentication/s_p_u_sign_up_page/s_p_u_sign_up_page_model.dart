...
class SPUSignUpPageModel extends FlutterFlowModel<SPUSignUpPageWidget> {
  ...
  String? _sPUSignUpAgeInputTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Age (years) is required';
    }

    if (!RegExp('^1[3-8]\$').hasMatch(val)) {
      return 'Age must be 13 - 25';
    }
    return null;
  }
  ...
  void initState(BuildContext context) {
    ...
    sPUSignUpAgeInputTextControllerValidator =
        _sPUSignUpAgeInputTextControllerValidator;
  }
