...
class SPUUserSportsPageWidget extends StatefulWidget {
  const SPUUserSportsPageWidget({super.key});

  static String routeName = 'SPUUserSportsPage';
  static String routePath = '/sPUUserSportsPage';

  @override
  State<SPUUserSportsPageWidget> createState() =>
      _SPUUserSportsPageWidgetState();
}

class _SPUUserSportsPageWidgetState extends State<SPUUserSportsPageWidget> {
  late SPUUserSportsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SPUUserSportsPageModel());
  }
