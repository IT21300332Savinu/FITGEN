...
import '/social_bridge/meetup/commentcomponent/commentcomponent_widget.dart';
import '/index.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';
import 's_p_u_all_meetup_page_model.dart';
export 's_p_u_all_meetup_page_model.dart';

class SPUAllMeetupPageWidget extends StatefulWidget {
  const SPUAllMeetupPageWidget({super.key});

  static String routeName = 'SPUAllMeetupPage';
  static String routePath = '/sPUAllMeetupPage';

  @override
  State<SPUAllMeetupPageWidget> createState() => _SPUAllMeetupPageWidgetState();
}

class _SPUAllMeetupPageWidgetState extends State<SPUAllMeetupPageWidget> {
  late SPUAllMeetupPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SPUAllMeetupPageModel());
  }
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => SPUMyMeetupPageWidget()),
            );
          },
          ...
          label: Row(
            ...
            children: [
              Icon(Icons.list, color: Color(0xFFFBFDFF), size: 24.0),
              Text(
                'My Meetups',
            ...
            children: [
              Container(
                ...
                child: FlutterFlowGoogleMap(
                  ...
                  initialLocation:
                      _model.googleMapsCenter ??= LatLng(13.106061, -59.613158),
              ...
              Flexible(
                child: StreamBuilder<List<MeetupRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<MeetupRecord> listViewMeetupRecordList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewMeetupRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewMeetupRecord =
                            listViewMeetupRecordList[listViewIndex];
                        return Padding(
