...
import '/social_bridge/meetup/create_meetup/create_meetup_widget.dart';
import '/index.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';
import 's_p_u_my_meetup_page_model.dart';
export 's_p_u_my_meetup_page_model.dart';

class SPUMyMeetupPageWidget extends StatefulWidget {
  const SPUMyMeetupPageWidget({super.key});

  static String routeName = 'SPUMyMeetupPage';
  static String routePath = '/sPUMyMeetupPage';

  @override
  State<SPUMyMeetupPageWidget> createState() => _SPUMyMeetupPageWidgetState();
}

class _SPUMyMeetupPageWidgetState extends State<SPUMyMeetupPageWidget> {
  late SPUMyMeetupPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SPUMyMeetupPageModel());
  }
              ...
              Flexible(
                child: StreamBuilder<List<MeetupReserveRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<MeetupReserveRecord> listViewMeetupReserveRecordList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewMeetupReserveRecordList.length,
