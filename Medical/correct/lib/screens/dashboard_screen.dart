...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget _buildHighHeartRateHint(double bpm) {
    if (bpm <= 160) return const SizedBox.shrink();
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: Colors.red[50],
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Heart Rate Reference Card (NEW FEATURE)
                    _buildHeartRateReferenceCard(),
                    const SizedBox(height: 20),
  ...
  Widget _buildHeartRateReferenceCard() {
    return Card(
      elevation: 4,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Heart Rate Ranges (simplified without boxes)
            Column(
              children: [
                _buildSimpleHeartRateRow(
                  icon: Icons.face,
                  iconColor: Colors.green,
                  title: 'Teens (13-19 years) - Resting',
                  range: '60-100 BPM',
                ),
                const SizedBox(height: 8),
                _buildSimpleHeartRateRow(
                  ...
                  iconColor: Colors.green,
                  title: 'Teens (13-19 years) - Training',
                  range: '100-165 BPM',
                ),
                const SizedBox(height: 8),
                _buildSimpleHeartRateRow(
                  ...
                  title: 'Adults (20-60 years) - Resting',
                  range: '60-100 BPM',
                ),
                const SizedBox(height: 8),
                _buildSimpleHeartRateRow(
                  ...
                  iconColor: Colors.blue,
                  title: 'Adults (20-60 years) - Training',
                  range: '95-160 BPM',
                ),
              ],
            ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      'Consult your healthcare provider for personalized heart rate targets',
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.black87,
  ...
  Widget _buildSimpleHeartRateRow({
