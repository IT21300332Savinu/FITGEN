...
class SPUBadmintonPageWidget extends StatefulWidget {
  const SPUBadmintonPageWidget({
    super.key,
    String? badmintonname,
  }) : this.badmintonname = badmintonname ?? 'badminton';

  final String badmintonname;
...
class _SPUBadmintonPageWidgetState extends State<SPUBadmintonPageWidget> {
  ...
  void initState() {
    ...
    _model.level3ExpandableController =
        ExpandableController(initialExpanded: false);
    _model.level4ExpandableController =
        ExpandableController(initialExpanded: false);
    _model.level5ExpandableController =
        ExpandableController(initialExpanded: false);
              ...
              child: ListView(
                ...
                children: [
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: FlutterFlowTimer(
                                          ...
                                          onEnded: () async {
                                            await WorkoutPlansRecord.collection
                                                .doc()
                                                .set(
                                      ...
                                      builder: (context) => FFButtonWidget(
                                        onPressed: () async {
                                          _model.timerController3
                                              .onStartTimer();
                                          if (_model.timerMilliseconds1 == 0) {
                                            await showDialog(
                                              context: context,
                                              builder: (dialogContext) {
                                                return Dialog(
                  ...
                  Container(
                    ...
                    color: FlutterFlowTheme.of(context).secondaryBackground,
                    child: ExpandableNotifier(
                      controller: _model.level4ExpandableController,
                      child: ExpandablePanel(
                        header: Padding(
                          padding: EdgeInsets.all(16.0),
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '1. Stand upright with feet apart.\n\n2. Lift the right arm forward to shoulder height (90°).\n\n3. Swing the arm forward gently, stopping halfway (about 45° past vertical).\n\n4. Return arm to side before repeating.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                                  ...
                                  Text(
                                    '1. Stand balanced with feet hip-width.\n\n2. Step forward with the left foot.\n\n3. Swing the right arm forward slowly at chest height\n\n4. Stop the swing once the arm is extended forward.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                                  ...
                                  Text(
                                    '1. Extend the right arm forward to shoulder height.\n\n2. Gently tap the air with the palm.\n\n3. Return to the starting position before repeating.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                  ...
                  Container(
                    ...
                    color: FlutterFlowTheme.of(context).secondaryBackground,
                    child: ExpandableNotifier(
                      controller: _model.level5ExpandableController,
                      child: ExpandablePanel(
                        header: Padding(
                          padding: EdgeInsets.all(16.0),
                          child: Container(
