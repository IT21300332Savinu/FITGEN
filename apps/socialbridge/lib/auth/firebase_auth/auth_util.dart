...
DocumentReference? get currentUserReference =>
    loggedIn ? SpecialUserRecord.collection.doc(currentUser!.uid) : null;

SpecialUserRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : SpecialUserRecord.getDocument(SpecialUserRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
